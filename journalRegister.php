...
<?php echo '<script src="app/journal/read.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/journal/delete.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/journal/update.js' ."?ts=". time() . '"></script>'; ?>
