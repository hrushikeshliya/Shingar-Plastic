...
<?php echo '<script src="app/city/read.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/city/create.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/city/delete.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/city/update.js' ."?ts=". time() . '"></script>'; ?>
</body>
</html>