...
<?php echo '<script src="app/purchaseReturn/create.js' ."?ts=". time() . '"></script>'; ?>
    ...
    function addItem() {    
            ...
            if(quantity !=0 && selectedIndex != 0) {
                ...
                $.getJSON(apiURL2+"/item/readOne.php?id=" + id+"&ts="+Math.random(), function(data){   // Change Needed HERE
                            ...
                            markup += "<td><input name='quantity' class='listQuantity form-control' onkeyup=getBillAmount() onchange=getBillAmount() value='"+quantity+"' type='number' min='1' max='"+maxQuantity+"'></td>";
