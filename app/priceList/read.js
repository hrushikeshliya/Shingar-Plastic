...
read_html+="<label>";
read_html+="<input list='accountNameList' id='accountName' name='accountName' id='myInput' onkeyup='search()' class='form-control pull-left m-b-15px' id='myInput' onkeyup='search()' placeholder='Search'/></label>";
