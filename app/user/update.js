$(document).ready(function () {
	...
	$(document).on('click', '.update-button', function () {
		...
		$.getJSON(apiURL + "/user/readOne.php?id=" + id + "&ts=" + Math.random(), function (data) {  // Change Needed HERE
			...
			$.getJSON(apiURL + "/roles/read.php" + "?ts=" + Math.random(), function (data) {
	...
	$(document).on('submit', '#update-form', function () {
		...
		$.ajax({
			url: apiURL + "/user/update.php",   // Change Needed HERE
			type: "POST",
			crossDomain: true,
