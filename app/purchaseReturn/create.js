...
function create() {
    ...
    $.getJSON(apiURL + "/singleValues/read.php?type=purchaseReturn" + "&ts=" + Math.random(), function (data) {
        ...
        $.getJSON(apiURL + "/purchase/read.php?type=distinctAccount" + "&ts=" + Math.random(), function (data) {
            ...
            changePageTitle("Create Purchase Return Entry"); // Change Needed HERE
            $("#loaderDiv").hide();
