...
<td class='text-right text-success'>`+parseFloat(data.openingBalanceNet).toFixed(3)+`</td>
</tr>`;

$.each(data.debitTransactionsNet, function(key, val) { 

  debitSubTotalNet+=parseFloat(val.amount);
...
<td class='text-right text-info'>`+parseFloat(debitSubTotalNet).toFixed(3)+`</td>
</tr>
...
<td class='text-right text-info'>`+(parseFloat(data.openingBalanceNet+debitSubTotalNet).toFixed(3))+`</td>
</tr>
...
$.each(data.creditTransactionsNet, function(key, val) { 

  creditSubTotalNet+=parseFloat(val.amount);
...
<td></td>
<td class='text-info text-right'>Sub Total</td>
<td class='text-right text-info'>`+parseFloat(creditSubTotalNet).toFixed(3)+`</td>
</tr>
...
<td class='text-right text-danger'>`+parseFloat(data.closingBalanceNet).toFixed(3)+`</td>
</tr>
...
<td></td>
<td class='text-info text-right'>Ledger Tally</td>
<td class='text-right text-info'>`+(parseFloat(data.closingBalanceNet+creditSubTotalNet).toFixed(3))+`</td>
</tr>
