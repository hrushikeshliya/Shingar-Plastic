$(document).ready(function(){
	...
	$.getJSON("http://shingarplastic.com/api/itemGroup/readOne.php?id=" + id, function(data){   // Change Needed HERE
		...
		read_one_html+="<table class='table table-bordered table-hover'>";
		    ...
		    read_one_html+="<tr>";
		        read_one_html+="<td>Item Group Name</td>";
		        read_one_html+="<td>" + data.name + "</td>";
		    read_one_html+="</tr>";
			
			read_one_html+="<tr>";
				read_one_html+="<td>Raw Type</td>";
				read_one_html+="<td>" + data.rawType + "</td>";
			read_one_html+="</tr>";
		...
		changePageTitle("Item Group Details");  // Change Needed HERE
	});
