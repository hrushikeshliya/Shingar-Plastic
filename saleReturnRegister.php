...
<?php echo '<script src="app/saleReturn/read.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/saleReturn/delete.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/saleReturn/update.js' ."?ts=". time() . '"></script>'; ?>
