...
<?php echo '<script src="app/materialIssue/read.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/materialIssue/readOne.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/materialIssue/delete.js' ."?ts=". time() . '"></script>'; ?>
<?php echo '<script src="app/materialIssue/update.js' ."?ts=". time() . '"></script>'; ?>
</body>
</html>